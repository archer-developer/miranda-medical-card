...
- Answer Generator должен формулировать ответ так, чтобы было понятно происхождение факта (например "по вашим собственным записям..." вместо "согласно результатам анализа...") — см. `../mcp/04-medical.md` §16;
